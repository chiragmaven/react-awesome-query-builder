...
var sqlFormat = function sqlFormat(tree, config) {
  ...
  var res = sqlFormatItem(tree, config, meta);
...
var sqlFormatValue = function sqlFormatValue(meta, config, currentValue, valueSrc, valueType, fieldWidgetDefinition, fieldDefinition, operator, operatorDefinition) {
...
var sqlFormatItem = function sqlFormatItem(item, config, meta) {
  ...
  if ((type === 'group' || type === 'rule_group') && children && children.size) {
    ...
    var value = properties.get('value').map(function (currentValue, ind) {
      ...
      var fv = sqlFormatValue(meta, config, currentValue, valueSrc, valueType, fieldWidgetDefinition, fieldDefinition, operator, operatorDefinition);
