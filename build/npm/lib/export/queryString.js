...
var formatValue = function formatValue(config, currentValue, valueSrc, valueType, fieldWidgetDefinition, fieldDefinition, operator, operatorDefinition, isForDisplay) {
  ...
  if (valueSrc == 'field') {
    ...
    if (typeof fieldWidgetDefinition.formatValue === 'function') {
      ...
      (0, _omit["default"])(fieldWidgetDefinition, ['formatValue', 'mongoFormatValue', 'sqlFormatValue', 'jsonLogic']), isForDisplay];
...
var queryString = function queryString(item, config) {
  ...
  if ((type === 'group' || type === 'rule_group') && children && children.size) {
    ...
    var args = [formattedField, operator, formattedValue, valueSrcs.length > 1 ? valueSrcs : valueSrcs[0], valueTypes.length > 1 ? valueTypes : valueTypes[0], (0, _omit["default"])(operatorDefinition, ['formatOp', 'mongoFormatOp', 'sqlFormatOp', 'jsonLogic']), operatorOptions, isForDisplay, fieldDefinition];
