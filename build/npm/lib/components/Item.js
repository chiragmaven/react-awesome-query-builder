...
var typeMap = {
  ...
  rule_group: function rule_group(props) {
    return /*#__PURE__*/_react["default"].createElement(_RuleGroup["default"], _extends({}, props.properties.toObject(), {
      id: props.id,
      path: props.path,
      actions: props.actions,
      config: props.config //tree={props.tree}
...
Item.propTypes = {
  ...
  parentField: _propTypes["default"].string //from RuleGroup
