  ...
  _createClass(Rule, [{
    ...
    value: function render() {
      ...
      var _this$props$config$se = this.props.config.settings,
          deleteLabel = _this$props$config$se.deleteLabel,
          renderBeforeWidget = _this$props$config$se.renderBeforeWidget,
          renderAfterWidget = _this$props$config$se.renderAfterWidget,
          renderSize = _this$props$config$se.renderSize,
          immutableGroupsMode = _this$props$config$se.immutableGroupsMode,
          immutableFieldsMode = _this$props$config$se.immutableFieldsMode,
          immutableOpsMode = _this$props$config$se.immutableOpsMode,
          immutableValuesMode = _this$props$config$se.immutableValuesMode;
      ...
      var beforeWidget = renderBeforeWidget && /*#__PURE__*/_react["default"].createElement(_col["default"], {
      ...
      var afterWidget = renderAfterWidget && /*#__PURE__*/_react["default"].createElement(_col["default"], {
